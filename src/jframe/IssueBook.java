...
public class IssueBook extends javax.swing.JFrame {
    ...
    public IssueBook() {
        initComponents();
        l = new Locale("en", "US");
        d_issueDate.setLocale(l);
    }

    //to get the book's details from the database and display it to book details panel
    ...
    //to get the student's details from the database and display it to student details panel
    ...
    public boolean issueBook() {
        ...
        Date uIssue = d_issueDate.getDate();
        Date uDue = d_dueDate.getDate();

        Long l3 = uIssue.getTime();
        Long l4 = uDue.getTime();

        java.sql.Date sIssue = new java.sql.Date(l3);
        java.sql.Date sDue = new java.sql.Date(l4);
    ...
    private void initComponents() {
        ...
        d_dueDate = new com.toedter.calendar.JDateChooser();
        d_issueDate = new com.toedter.calendar.JDateChooser();
        ...
        jPanel1.setBackground(new java.awt.Color(99, 163, 65));
        ...
        jPanel1.add(lbl_studentError, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 750, 360, 40));
        ...
        jPanel3.add(lbl_bookError, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 750, 350, 40));
        ...
        panel_main.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 0, 110, -1));
        ...
        rSMaterialButtonCircle2.setBackground(new java.awt.Color(232, 86, 70));
        ...
        panel_main.add(rSMaterialButtonCircle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 690, 350, 70));

        d_dueDate.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        d_dueDate.setInheritsPopupMenu(true);
        panel_main.add(d_dueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 600, 320, 40));

        d_issueDate.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        d_issueDate.setInheritsPopupMenu(true);
        panel_main.add(d_issueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 510, 320, 40));
    ...
    private com.toedter.calendar.JDateChooser d_dueDate;
    private com.toedter.calendar.JDateChooser d_issueDate;
